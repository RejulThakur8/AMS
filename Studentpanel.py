...
class StudentPanel:
    def __init__(self):
        self.y=Tk()
        self.img=PhotoImage(file=r'C:/Users/HP/OneDrive/Pictures/Screenshots/T4.png')
    ...
    def login(self):
        if self.y:          ##
            self.y.destroy()        ##
        self.y1=Tk()
        self.img=PhotoImage(file=r'C:/Users/HP/OneDrive/Pictures/Screenshots/T1.png')
        l=Label(text='',image=self.img)
        l.place(x=0,y=0)
...
##      data=cr.fetchall()
        ...
        if data:
            ...
            frame2=Frame(self.y2,bg="skyblue",padx=50,pady=200)
